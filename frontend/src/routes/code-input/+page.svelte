...
<div class="container">
    <div class="header">
        ...
        <div class="left-section">
            ...
            <div class="prj-settings">{lastModified} • {size}</div>
        </div>
        ...
        <div class="right-section">
            ...
            <button class="invite-button"><img src="./images/icon-invite.svg" alt="">Пригласить</button>
...
<style>
    ...
    .icons img {width: 1.5rem; height: 1.5rem;}

    .prj-settings {color: #7E7E7E;}
